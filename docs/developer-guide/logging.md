...
*  The output logging level can be controlled using the `logLevel` setting in the configuration file (See the [Configuration guide](/developer-guide/configuration.html) section).
