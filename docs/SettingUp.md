...
1. **Verify the setup**:
   ...
   1. [Run the tests]({{ baseUrl }}/Testing.md) to ensure they all pass.
...
1. **Learn the design**
   ...
   When you are ready to start coding, we recommend that you get some sense of the overall design by reading about [B2B4U’s architecture]({{ baseUrl }}/DeveloperGuide.md#design).
